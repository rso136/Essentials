...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-8 col-md-offset-2 col-xs-12" id="aboutBox">
			<div id="aboutHeading">
				<h2><b>About Essentials</b></h2>
			</div>
			<br>
			<img id="aboutProfile" class="img-circle" src="assets/images/profile.jpg" height="150" width="150">
			<p>I developed Essentials because I wanted to create a better way for me to manage my household expendables and organize my shopping list via computer or mobile device. Not wanting to keep the application to myself, I decided to make Essentials a web application accessible to anyone.</p> 
			<p>If you had questions about Essentials or had issues with your Essentials account, please feel free to <a href="mailto:rso136@gmail.com" target="_blank">contact me.</a> I am always open to feedback or suggestions.</p>
			<h3 id="signature">- Richard Oh</h3>
